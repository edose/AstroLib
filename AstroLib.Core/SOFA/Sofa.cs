...
public static class Sofa {
    ...
    // Apcg():  NOT IMPLEMENTED: earth ephemeris must be supplied by caller. 
    ...
    // Apci():  NOT IMPLEMENTED: earth ephemeris must be supplied by caller. 
    ...
    // Apco():  NOT IMPLEMENTED: earth ephemeris must be supplied by caller. 
    ...
    // Apcs():  NOT IMPLEMENTED: earth ephemeris must be supplied by caller. 
    ...
    // Aper():  NOT IMPLEMENTED: earth ephemeris must be supplied by caller. 
    ...
    // Apio():  NOT IMPLEMENTED: earth ephemeris must be supplied by caller. 
    ...
    // Atciqn():  NOT IMPLEMENTED: needs list of light-deflecting bodies,
    //            of low relevance to amateur astronomy. 
    ...
    // Aticqn():  NOT IMPLEMENTED: needs list of light-deflecting bodies,
    //            of low relevance to amateur astronomy. 
    ...
    /// <param name="wl">Observation wavelength (micrometers).</param> 
    /// <returns>2-tuple of doubles: rc, dc: RA, Dec (ICRS astrometric).</returns>.
    public static Tuple<double, double> Atoc13(string type, double ob1, double ob2, double utc1,
        double utc2,
        double dut1, double elong, double phi, double hm, double xp, double yp,
        double phpa, double tc, double rh, double wl) {
        double rc = 0, dc = 0;
    ...
    public static Tuple<double, double> Atoi13(string type, double ob1, double ob2, double utc1,
        double utc2,
        double dut1, double elong, double phi, double hm, double xp, double yp,
        double phpa, double tc, double rh, double wl) {
        double ri = 0, di = 0;
    ...
    // Ee00():      NOT IMPLEMENTED: AstroLib deprecates equation of equinoxes in favor of CIO.
    // Ee00a():     NOT IMPLEMENTED: AstroLib deprecates equation of equinoxes in favor of CIO.
    // Ee00b():     NOT IMPLEMENTED: AstroLib deprecates equation of equinoxes in favor of CIO.
    // Ee06a():     NOT IMPLEMENTED: AstroLib deprecates equation of equinoxes in favor of CIO.
    // Eect00():    NOT IMPLEMENTED: AstroLib deprecates equation of equinoxes in favor of CIO.
    // Eqeq94():    NOT IMPLEMENTED: AstroLib deprecates equation of equinoxes in favor of CIO.
    ...
    // All functions in Fundamental Arguments section:  NOT IMPLEMENTED.
    ...
    /// <summary> Sofa.Tpors(): In the tangent plane (gnomonic) projection, given the rectangular
    /// coordinates of a star and its spherical coordinates,
    /// determine the spherical coordinates of the tangent point.</summary>
    ...
    // Tporv():  NOT IMPLEMENTED: Yields direction cosines. Prefer Tpors().
    ...
    // Tpstv():  NOT IMPLEMENTED: Yields direction cosines. Prefer Tpsts().
    ...
    // Tpxev():  NOT IMPLEMENTED: Yields direction cosines. Prefer Tpxes().
    ...
    /// <summary>Sofa.Ae2hd(): Transform azimuth and altitude to hour angle and declination.</summary>
    ...
    /// <summary>Sofa.Hd2ae(): Transform hour angle and declination to azimuth and altitude.</summary>
    ...
    // Hd2pa():  NOT IMPLEMENTED: Parallactic angle of low priority for amateur astronomy. (later?)
    ...
    // Num00b():  NOT IMPLEMENTED: Nutation matrix of low relevance to amateur astronomy.
    // Num06a():  NOT IMPLEMENTED: Nutation matrix of low relevance to amateur astronomy.
    // Num80():   NOT IMPLEMENTED: Nutation matrix of low relevance to amateur astronomy. Outdated model.
    // Nutm80():  NOT IMPLEMENTED: Nutation matrix of low relevance to amateur astronomy. Outdated model.
    ...
    // Fk425():  NOT IMPLEMENTED: Previous catalog systems typically of low relevance to amateur astronomy.
    // Fk45z():  NOT IMPLEMENTED: Previous catalog systems typically of low relevance to amateur astronomy.
    // Fk524():  NOT IMPLEMENTED: Previous catalog systems typically of low relevance to amateur astronomy.
    // Fk52h():  NOT IMPLEMENTED: Previous catalog systems typically of low relevance to amateur astronomy.
    // Fk54z():  NOT IMPLEMENTED: Previous catalog systems typically of low relevance to amateur astronomy.
    // Fk5hip(): NOT IMPLEMENTED: Previous catalog systems typically of low relevance to amateur astronomy.
    // Fk5hz():  NOT IMPLEMENTED: Previous catalog systems typically of low relevance to amateur astronomy.
    // H2fk5():  NOT IMPLEMENTED: Previous catalog systems typically of low relevance to amateur astronomy.
    // Hfk5z():  NOT IMPLEMENTED: Previous catalog systems typically of low relevance to amateur astronomy.
    ...
    // TODO: Implement S2c() (spherical to unit vector).
    ...
    // TODO: Implement Rxpv: Multiply a pv−vector by an r−matrix.

    // Trxp():     NOT IMPLEMENTED. Implement later if needed.
    // Trxpv():    NOT IMPLEMENTED. Implement later if needed.
    ...
    // Pap():    NOT IMPLEMENTED. Implement later if needed.
    // Pas():    NOT IMPLEMENTED. Implement later if needed.
